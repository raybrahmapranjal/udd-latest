...
export default function StatsStrip() {
  ...
  return (
    <section ref={ref} className="relative z-20 py-16 md:py-24 px-4 sm:px-6 md:px-16 lg:px-32 bg-lightgray">
      <div className="flex flex-col items-center mb-12 md:mb-16 text-center">
        ...
        <div className="inline-block border-b-4 border-orange-500 pb-2 mb-4">
          <h2 className="text-4xl md:text-5xl font-bold text-navy uppercase tracking-tight">UDD BTC at a Glance</h2>
        </div>
        <p className="text-gray-500 max-w-xl mx-auto font-medium text-lg leading-relaxed">Key metrics and developmental statistics of Urban Development Department in BTC.</p>
      </div>
        ...
        {stats.map((stat, idx) => {
          ...
          >
            ...
            <div className={`flex-1 text-center`}>
              <div className={`text-5xl md:text-6xl font-bold text-gray-900 mb-2 flex items-center justify-center gap-1`}>
