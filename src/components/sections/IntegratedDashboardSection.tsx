    ...
    <section className="py-12 md:py-24 px-4 sm:px-6 md:px-12 lg:px-24 bg-gray-50 overflow-hidden">
      <div className="flex flex-col items-center mb-12 md:mb-20 text-center">
        ...
        <div className="inline-block border-b-4 border-blue-600 pb-2 mb-4">
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-navy uppercase tracking-tight">Integrated UDD BTC Dashboard</h2>
        </div>
          ...
          >
            <div>
              <div className="flex justify-between items-start sm:items-center mb-6 gap-2">
                  ...
                  <span className={`px-3 py-1 sm:px-4 sm:py-1.5 bg-gradient-to-r ${section.badgeBgGradient} ${section.badgeText} text-[9px] sm:text-xs font-bold rounded-full whitespace-nowrap shadow-sm uppercase tracking-wider`}>
                    {section.badge}
                  </span>
              </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-2 mt-auto">
                        ...
                        {item.amount && <span className="text-[10px] sm:text-xs font-bold text-emerald-700 bg-emerald-50/80 px-2.5 py-1 rounded-md border border-emerald-300 shadow-sm">{item.amount}</span>}
                        {item.status && <span className="text-[10px] sm:text-xs font-bold text-amber-700 bg-amber-50/80 px-2.5 py-1 rounded-md border border-amber-300 shadow-sm">{item.status}</span>}
                    </div>
                 </motion.div>
              </AnimatePresence>
            </div>
