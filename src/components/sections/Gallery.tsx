...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="py-16 md:py-24 px-4 sm:px-6 md:px-16 lg:px-32 bg-lightgray">
       <div className="flex flex-col items-center mb-12 md:mb-16 text-center">
        ...
        <div className="inline-block border-b-4 border-navy pb-2 mb-4">
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-navy uppercase tracking-tight">Our Gallery of UDD BTC Development</h2>
        </div>
        <p className="text-gray-500 max-w-2xl mx-auto font-medium text-sm md:text-lg leading-relaxed px-4">Visualizing the urban transformation and infrastructure development across BTC.</p>
      </div>
