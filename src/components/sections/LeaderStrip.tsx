      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center mb-12 md:mb-20 text-center">
          ...
          <div className="inline-block border-b-4 border-navy pb-2 mb-4">
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-navy uppercase tracking-tight">Leadership & Vision of UDD BTC Governance</h2>
          </div>
              ...
              <div key={idx} className="relative group pt-16">
                ...
                >
                  <div className="mb-6 text-center">
                    <h4 className="text-xl font-bold text-navy mb-1 tracking-tight">{leader.name}</h4>
                  ...
                  <div className={`p-5 rounded-xl mb-8 flex-grow ${theme.bg}`}>
                    <p className={`font-bold text-[10px] uppercase tracking-wider mb-4 ${theme.text}`}>
                      {leader.focusTitle}
                    </p>
