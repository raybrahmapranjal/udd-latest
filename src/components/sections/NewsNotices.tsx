      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-8">
            ...
            <button className="mt-8 text-[11px] font-black uppercase tracking-widest text-orange-600 hover:text-navy transition-colors flex items-center gap-2 group">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-4">
            ...
            <button className="mt-8 text-[11px] font-black uppercase tracking-widest text-blue-600 hover:text-navy transition-colors flex items-center gap-2 group">
