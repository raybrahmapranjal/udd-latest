...
const ulbsDatabase: Record<string, ULBData> = {
  basugaon_mb: {
    ...
    chairpersonEmail: "chair.basugaon@btc.gov.in",
    execOfficer: "Sri Himangshu Kumar, ACS",
    execOfficerPhone: "03664-295050",
    execOfficerEmail: "eo.basugaon@btc.gov.in",
  ...
  bijni_mb: {
    ...
    chairpersonEmail: "chair.bijni@btc.gov.in",
    execOfficer: "Smt. Kakali Karjee, ACS",
    execOfficerPhone: "03664-295240",
    execOfficerEmail: "eo.bijni@btc.gov.in",
  ...
  fakiragram_mb: {
    ...
    chairpersonEmail: "chair.fakiragram@btc.gov.in",
    execOfficer: "Sri Alakesh Baruah, ACS",
    execOfficerPhone: "03661-294112",
    execOfficerEmail: "eo.fakiragram@btc.gov.in",
  ...
  goreswar_mb: {
    ...
    chairpersonEmail: "chair.goreswar@btc.gov.in",
    execOfficer: "Sri Nabajit Pathak, ACS",
    execOfficerPhone: "03624-291136",
    execOfficerEmail: "eo.goreswar@btc.gov.in",
  ...
  gossaigaon_mb: {
    ...
    chairpersonEmail: "chair.gossaigaon@btc.gov.in",
    execOfficer: "Shri Monoj Kumar Das",
    execOfficerPhone: "03662-272100",
    execOfficerEmail: "eo.gossaigaon@btc.gov.in",
  ...
  kajalgaon_mb: {
    ...
    chairpersonEmail: "chair.kajalgaon@btc.gov.in",
    execOfficer: "Smt. Bornali Devi, ACS",
    execOfficerPhone: "03664-293345",
    execOfficerEmail: "eo.kajalgaon@btc.gov.in",
  ...
  kokrajhar_mb: {
    ...
    chairpersonEmail: "chair.kokrajhar@btc.gov.in",
    execOfficer: "Sri Mukta Das, ACS",
    execOfficerPhone: "03661-270244",
    execOfficerEmail: "eo.kokrajhar@btc.gov.in",
  ...
  mushalpur_mb: {
    ...
    chairpersonEmail: "chair.mushalpur@btc.gov.in",
    execOfficer: "Sri Bipul Kumar Roy, ACS",
    execOfficerPhone: "03624-296060",
    execOfficerEmail: "eo.mushalpur@btc.gov.in",
  ...
  tamulpur_mb: {
    ...
    chairpersonEmail: "chair.tamulpur@btc.gov.in",
    execOfficer: "Smt. Juri Gogoi, ACS",
    execOfficerPhone: "03624-298124",
    execOfficerEmail: "eo.tamulpur@btc.gov.in",
  ...
  tangla_mb: {
    ...
    chairpersonEmail: "chair.tangla@btc.gov.in",
    execOfficer: "Smt. Bornali Baruah, ACS",
    execOfficerPhone: "03711-296211",
    execOfficerEmail: "eo.tangla@btc.gov.in",
                  ...
                  <div className="flex items-start gap-4 p-4 bg-[#faf5ff]/90 border-l-[3.5px] border-l-purple-600 rounded-xl transition-all duration-200">
                    ...
                    <div>
                      ...
                      <p className="text-xs md:text-[13px] font-bold text-slate-600 break-all leading-normal">
                        {ulbId === 'gossaigaon_mb' 
                          ? "gossaigaon.mb@btc.gov.in" 
                          : (board.email || `${ulbId.replace('_mb', '')}.mb@btc.gov.in`)
                        }
                      </p>
                    </div>
                  </div>
