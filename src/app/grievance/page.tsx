  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <section className="relative py-16 overflow-hidden bg-slate-950 text-white border-b border-purple-950/30 shadow-lg text-center">
        ...
        <div className="max-w-4xl mx-auto relative z-20 px-4 pt-4">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 md:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="flex bg-white rounded-xl shadow-md p-1.5 border border-green-200 mb-2 max-w-md mx-auto">
              <button
          ...
          {activeTab === 'submit' ? (
            ...
            >
              {submitSuccess ? (
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-orange-400 border-l-[4px] border-l-[#ff6600] overflow-hidden max-w-4xl mx-auto">
                  <div className="bg-gradient-to-r from-orange-200 via-orange-300 to-white-400 py-5 px-6 sm:px-8 border-b-1 border-orange-500 flex justify-between items-center">
                    <div>
                      <h2 className="text-lg sm:text-xl font-bold text-[#003366] uppercase tracking-tight">Official Lodge Registry Form</h2>

                      <p className="text-orange-900 text-xs mt-0.5">
                        Please ensure all required tags indicated with * are filled truthfully
                      </p>
                    </div>
            ...
            >
              ...
              <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8 border border-green-300 border-l-4 border-l-green-500">
                ...
                <form onSubmit={handleTrackSearch} className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button
                    type="submit"
                    className="bg-[#00d492] hover:bg-slate-900 text-white font-bold text-xs tracking-widest uppercase px-8 py-4 sm:py-0 rounded-xl shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-1.5 shrink-0 h-[48px] sm:h-[54px]"
                  >
