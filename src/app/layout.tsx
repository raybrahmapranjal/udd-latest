...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "/udd-favicon.png",
    shortcut: "/udd-favicon.png",
    apple: "/udd-favicon.png",
  },
  openGraph: {
    type: "website",
    locale: "en_IN",
    url: "https://udd-latest.vercel.app/",
    title: "Urban Development Department | Bodoland Territorial Council",
    ...
    images: [
      {
        url: "https://udd-latest.vercel.app/images/btc-logo.png",
        width: 1200,
        height: 630,
        alt: "UDD BTC Logo",
      }
  ...
  twitter: {
    ...
    images: ["https://udd-latest.vercel.app/images/btc-logo.png"],
    creator: "@UDD_BTC",
  },
  robots: {
    index: true,
